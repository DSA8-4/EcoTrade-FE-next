      ...
      <section className={styles.transactionSection}>
        ...
        <div className={styles.transactionList}>
          <div className={styles.transactionItem}>
            ...
            <span className={`${styles.itemStatus} ${styles.statusOnSale}`}>
              판매중
            </span>
          </div>
          <div className={styles.transactionItem}>
            ...
            <span className={`${styles.itemStatus} ${styles.statusInProgress}`}>
              거래중
            </span>
          </div>
          <div className={styles.transactionItem}>
            ...
            <span className={`${styles.itemStatus} ${styles.statusCompleted}`}>
              거래완료
            </span>
          </div>
        </div>
